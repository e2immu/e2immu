...
#TODO# We currently use `thisRead` and `localMethodsCalled` to compute the @NotModifed property of the method.
We could do this is a better way by allowing variable properties to be computed for This as well.
