...
Constants:: This group consists of primitives, String, Class, Null.
...
Error:: temporary value used as a marker, for technical reasons only (we could get rid of this)
No value:: temporary value to indicate that certain evaluations have not been concluded yet
Unknown value:: value without properties, which means currently that it has the properties of a constant.
So a better name would be #Unknown constant#.
