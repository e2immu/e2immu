...
In order to keep the narrative going, we defer a discussion of modification in the context of parameters of abstract and interface types to the section <<modification-part2>>.
