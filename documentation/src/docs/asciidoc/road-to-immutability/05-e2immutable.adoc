...
To compute linking, the analyser tracks actual objects rather than

Linking rules:

. an assignment of a parameter or field to that parameter links the field to that other field or parameter
. an assignment to th
