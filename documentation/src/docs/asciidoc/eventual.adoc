...
| -1    | delay | - | -
| 0     | nullable  | `@Nullable` | `@Nullable`
| 1     | eventually not null, before mark | (makes no sense) | -
| 2     | eventually not null | - | `@NotNull(after="...")`
| 3     | eventually not null, after mark | `@NotNull` |
| 4     | not null | `@NotNull` | `@NotNull`
| 5     | eventually content not null, before mark | `@NotNull` | -
| 6     | eventually content not null | - | `@NotNull1(after="...")`
| 7     | eventually content not null, after mark | `@NotNull1` | -
| 8     | contents not null | `@NotNull1` | `@NotNull1`
| ...   | ... | ... |...
| 12    | contents`' content not null | `@NotNull2` |  `@NotNull2`
|===
