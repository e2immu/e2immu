...
| -1    | delay | - | -
| 0,0   | not level 1 immutable | -  | `@Mutable`
| 1,0   | eventually level 1 immutable, before mark | `@BeforeImmutableMark` | -
...
| 3,0   | eventually level 1 immutable, after mark | `@E1Immutable` | -
| 4,0   | effectively level 1 immutable | `@E1Immutable` when formal type is not (eventually) level 1 immutable |`@E1Immutable`
| 1,1   | eventually level 1 & 2 immutable, before mark | `@BeforeImmutableMark` | -
| 4,1   | effectively level 1, eventually level 2 immutable, before mark | `@BeforeImmutableMark @E1Immutable` | -
| 2,2   | eventually level 1 & 2 immutable .2+| `@E2Immutable` when formal type is not (eventually) level 2 immutable .2+| `@E2Immutable(after="...")`
| 4,2   | effectively level 1, eventually level 2 immutable
| 3,3   | eventually level 2 immutable after mark | `@E2Immutable` | -
| 4,4   | effectively level 2 immutable | `@E2Immutable` when formal type is not (eventually) level 2 immutable | `@E2Immutable`
|===
