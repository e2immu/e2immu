...
Intentionally we raise an error when a parameter to a method is assigned to in the method body.
The method analyser determines this in a straightforward way, by looking at the `ASSIGNED` property in the evaluation context.