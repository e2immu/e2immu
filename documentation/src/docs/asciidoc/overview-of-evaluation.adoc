...
- should we forbid the use of fields where local variables will do the trick? (No repeated assignments, no field assignments in loops unless there’s an escape (break, return)?
