...
public class CheckOnly {
    ...
    public static void checkOnly(TypeContext typeContext, MethodInfo methodInfo) {
        ...
        if (mustBeAbsent) {
            ...
            typeContext.addMessage(Message.newMessage(new Location(methodInfo),
    ...
    public static void checkMark(TypeContext typeContext, MethodInfo methodInfo) {
        MethodAnalysis.OnlyData onlyData = methodInfo.methodAnalysis.get().onlyData.isSet() ?
                methodInfo.methodAnalysis.get().onlyData.get() : null;
