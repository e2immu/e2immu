...
public interface AnalyserContext extends AnalysisProvider, InspectionProvider {
    ...
    default DV typeRelation(ParameterizedType pt1, ParameterizedType pt2) {
        ...
        if (b1 == null) {
            ...
            /*
            what to do when pt1 = T, the type parameter of the current type, and
            hidden content types of pt2=List<T> = {E}? We need to translate from E --> T
             */
            assert t2.getHiddenContentTypes().translate(this, pt2).contains(pt1);
        ...
        if (b2 == null) {
            ...
            assert t1.getHiddenContentTypes().translate(this, pt1).contains(pt2);
            return LinkedVariables.LINK_IS_HC_OF;
        }
        if (!pt1.equals(pt2)) {
            TypeAnalysis t1 = getTypeAnalysis(b1);
            ...
            SetOfTypes translatedHcOfT1 = t1.getHiddenContentTypes().translate(this, pt2);
            ...
            SetOfTypes translatedHcOfT2 = t2.getHiddenContentTypes().translate(this, pt1);
