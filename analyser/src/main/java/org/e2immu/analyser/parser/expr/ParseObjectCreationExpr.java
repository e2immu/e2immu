...
public class ParseObjectCreationExpr {
    public static Expression parse(ExpressionContext expressionContext, ObjectCreationExpr objectCreationExpr, MethodTypeParameterMap singleAbstractMethod) {
        ...
        if (objectCreationExpr.getAnonymousClassBody().isPresent()) {
            ...
            new Resolver().sortTypes(Map.of(anonymousType, expressionContext.typeContext));
        ...
        MethodTypeParameterMap method = ParseMethodCallExpr.evaluateCall(expressionContext, methodCandidates, objectCreationExpr.getArguments(),
