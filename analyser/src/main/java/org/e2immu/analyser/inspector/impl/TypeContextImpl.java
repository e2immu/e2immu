...
import org.e2immu.analyser.inspector.ImportMap;
...
public class TypeContextImpl implements TypeContext {
    ...
    private final String packageName; // this one is filled in UNLESS parentContext == null, because that is the root level
    ...
    @Override
    public NamedType getSimpleName(String name) {
