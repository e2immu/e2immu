...
public class TypeInspectorImpl implements TypeInspector {
            ...
            if (dollarTypesAreNormalTypes) {
                ...
                dollarResolver = name -> {
                    if (name.endsWith("$") && dollarPackageName != null) {
                        ...
                        return typeContext.typeMapBuilder().getOrCreateByteCode(dollarPackageName, substring);
                    }
                    return null;
                };
            }
    ...
    private void annotationMember(ExpressionContext expressionContext,
        ...
        TypeMap.Builder typeMapBuilder = expressionContext.typeContext().typeMapBuilder();
    ...
    private void initializerDeclaration(ExpressionContext expressionContext,
        ...
        if (fullInspection) {
            TypeMap.Builder typeMapBuilder = expressionContext.typeContext().typeMapBuilder();
            MethodInspector methodInspector = new MethodInspectorImpl(typeMapBuilder,
    ...
    private void compactConstructorDeclaration(ExpressionContext expressionContext,
        ...
        TypeMap.Builder typeMapBuilder = expressionContext.typeContext().typeMapBuilder();
        MethodInspector methodInspector = new MethodInspectorImpl(typeMapBuilder, typeInfo,
    ...
    private void ensureCompactConstructor(List<RecordField> recordFields,
                                          ...
                                          ExpressionContext subContext) {
        assert recordFields != null;
        MethodInspector methodInspector = new MethodInspectorImpl(typeContext.typeMapBuilder(), typeInfo,
                fullInspection, storeComments);
    ...
    private void prepareSubType(TypeContext typeContext, DollarResolver dollarResolver, String
            nameAsString) {
        DollarResolverResult res = subType(typeContext.typeMapBuilder(), dollarResolver, nameAsString);
