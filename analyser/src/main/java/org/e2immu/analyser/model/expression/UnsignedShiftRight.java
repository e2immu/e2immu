...
public class UnsignedShiftRight extends BinaryOperator {
    ...
    private UnsignedShiftRight(Primitives primitives, Expression lhs, Expression rhs) {
    ...
    public EvaluationResult reEvaluate(EvaluationContext evaluationContext, Map<Expression, Expression> translation) {
        ...
        return builder.setExpression(UnsignedShiftRight.unsignedShiftRight(evaluationContext, reLhs.value(), reRhs.value())).build();
    }

    public static Expression unsignedShiftRight(EvaluationContext evaluationContext, Expression l, Expression r) {
        ...
        return new UnsignedShiftRight(primitives, l, r);
    }
