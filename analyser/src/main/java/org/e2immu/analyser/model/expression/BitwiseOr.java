...
public class BitwiseOr extends BinaryOperator {
    ...
    public EvaluationResult reEvaluate(EvaluationResult context, Map<Expression, Expression> translation, ForwardReEvaluationInfo forwardReEvaluationInfo) {
        ...
        return builder.setExpression(BitwiseOr.bitwiseOr(identifier, context, reLhs.value(), reRhs.value())).build();
    }
    ...
    public Expression mergeDelays(CausesOfDelay causesOfDelay) {
        ...
        if (l != lhs || r != rhs) return new BitwiseOr(identifier, primitives, l, r);
        return this;
    }
}
