        ...
        FieldAnalyserVisitor fieldAnalyserVisitor = d -> {
            if ("i".equals(d.fieldInfo().name)) {
                ...
                String sortedValues = d.iteration() == 0
                        ? "initial:java.lang.System.out@Method_increment_1-C;initial:q@Method_increment_1-E;initial:this.i@Method_increment_0-C;initial@Field_i;values:this.i@Field_i"
                        : "0,instance type int";
