        ...
        MethodAnalyserVisitor methodAnalyserVisitor = d -> {
            ...
            if ("valueOf".equals(d.methodInfo().name)) {
                ...
                String expect = d.iteration() < 4 ? "<m:valueOf>"
                        : "Arrays.stream({`Enum_0.ONE`,`Enum_0.TWO`,`Enum_0.THREE`}).filter(instance 0 type $1).findFirst().orElseThrow()";
            ...
            if ("isThree".equals(d.methodInfo().name)) {
                String expect = d.iteration() < 4 ? "<m:isThree>" : "/*inline isThree*/Enum_0.THREE==this$0";
                assertEquals(expect, d.methodAnalysis().getSingleReturnValue().toString());
                mustSeeIteration(d, 4);
            }
        };
