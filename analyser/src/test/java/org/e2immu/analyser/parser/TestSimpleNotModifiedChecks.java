...
public class TestSimpleNotModifiedChecks extends CommonTestRunner {
        ...
        public void visit(int iteration, FieldInfo fieldInfo) {
            ...
            if (fieldInfo.name.equals("set4")) {
                ...
                if (iteration >= 2) {
                    ...
                    Assert.assertEquals(Level.FALSE, fieldInfo.fieldAnalysis.get().getProperty(VariableProperty.NOT_MODIFIED));
    ...
    MethodAnalyserVisitor methodAnalyserVisitor = new MethodAnalyserVisitor() {
        ...
        public void visit(int iteration, MethodInfo methodInfo) {
            ...
            if ("add4".equals(methodInfo.name)) {
                ...
                if (iteration >= 2) {
                    Assert.assertEquals(Level.FALSE, methodInfo.methodAnalysis.get().getProperty(VariableProperty.NOT_MODIFIED));
                }
            }
            if ("Example6".equals(methodInfo.name)) {
                ...
                if (iteration == 0 || iteration == 1) {
                    ...
                    Assert.assertEquals(Level.DELAY, in6.parameterAnalysis.get().getProperty(VariableProperty.NOT_MODIFIED));
                } else {
                    Assert.assertEquals(Level.TRUE, in6.parameterAnalysis.get().getProperty(VariableProperty.NOT_NULL));
                    Assert.assertEquals(Level.FALSE, in6.parameterAnalysis.get().getProperty(VariableProperty.NOT_MODIFIED));
                }
            }
    ...
    TypeContextVisitor typeContextVisitor = new TypeContextVisitor() {
        ...
        public void visit(TypeContext typeContext) {
            ...
            int notModifiedAll = addAll.methodAnalysis.get().getProperty(VariableProperty.NOT_MODIFIED);
            Assert.assertEquals(Level.FALSE, notModifiedAll);
            ParameterInfo first = addAll.methodInspection.get().parameters.get(0);
            int notModifiedParam = first.parameterAnalysis.get().getProperty(VariableProperty.NOT_MODIFIED);
            Assert.assertEquals(Level.TRUE, notModifiedParam);
