    ...
    StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
        ...
        if ("get".equals(d.methodInfo().name)) {
            if (d.variable() instanceof FieldReference s && "supplier".equals(s.fieldInfo.name)) {
                ...
                assertDv(d, 8, MultiLevel.IGNORE_MODS_DV, Property.IGNORE_MODIFICATIONS);
            }
            if (d.variable() instanceof ReturnVariable) {
                if ("0.0.0".equals(d.statementId())) {
                    assertCurrentValue(d, 8, "t$0");
                }
                if ("2".equals(d.statementId())) {
                    ...
                    assertDv(d, 8, MultiLevel.EFFECTIVELY_NOT_NULL_DV, Property.NOT_NULL_EXPRESSION);
                }
            }
            if (d.variable() instanceof FieldReference t && "supplier".equals(t.fieldInfo.name)) {
                assertCurrentValue(d, 8, "instance type Supplier<T>/*@IgnoreMods*/");
                assertDv(d, 8, MultiLevel.EFFECTIVELY_IMMUTABLE_HC_DV, Property.IMMUTABLE);
            }
            ...
            if (d.variable() instanceof FieldReference t && "t".equals(t.fieldInfo.name)) {
                ...
                if ("0.0.0".equals(d.statementId())) {
                    assertCurrentValue(d, 8, "nullable instance type T");
                }
                if ("0".equals(d.statementId())) {
                    assertCurrentValue(d, 8, "nullable instance type T");
                }
    ...
    FieldAnalyserVisitor fieldAnalyserVisitor = d -> {
        if ("t".equals(d.fieldInfo().name)) {
            ...
            String expected = switch (d.iteration()) {
                ...
                case 2, 3, 4, 5, 6 -> "break_init_delay:this.t@Method_get_0.0.0-C;constructor-to-instance@Method_get_1-E;de:this.t@Method_get_2-E;ext_not_null@Field_supplier;initial:this.supplier@Method_get_1-C;initial:this.t@Method_get_0.0.0-C;link@Field_supplier;link@Field_t;values:this.t@Field_t";
            ...
            assertDv(d, 7, MultiLevel.EFFECTIVELY_IMMUTABLE_HC_DV, Property.EXTERNAL_IMMUTABLE);
        }
