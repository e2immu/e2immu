...
public class Test_Support_05_Lazy extends CommonTestRunner {
    ...
    StatementAnalyserVisitor statementAnalyserVisitor = d -> {
        if ("get".equals(d.methodInfo().name)) {
            String state = switch (d.iteration()) {
                ...
                case 4, 5, 6, 7, 8, 9 -> "<simplification>";
                default -> "true";
            };
            if ("1".equals(d.statementId())) {
    ...
    FieldAnalyserVisitor fieldAnalyserVisitor = d -> {
        if ("t".equals(d.fieldInfo().name)) {
            ...
            String expected = switch (d.iteration()) {
                ...
                case 2, 3, 4, 5, 6 -> "break_init_delay:this.t@Method_get_0.0.0-C;constructor-to-instance@Method_get_1-E;de:this.t@Method_get_2-E;ext_not_null@Field_supplier;initial:this.supplier@Method_get_1-C;initial:this.t@Method_get_0.0.0-C;link@Field_t;values:this.t@Field_t";
    ...
    MethodAnalyserVisitor methodAnalyserVisitor = d -> {
        ...
        if ("get".equals(d.methodInfo().name)) {
            String expect = d.iteration() <= 9 ? "Precondition[expression=<precondition>, causes=[]]"
