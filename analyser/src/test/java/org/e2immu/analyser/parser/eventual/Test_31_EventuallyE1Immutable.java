        ...
        StatementAnalyserVisitor statementAnalyserVisitor = d -> {
            if ("setString".equals(d.methodInfo().name)) {
                if ("1.0.0".equals(d.statementId())) {
                    String expected = d.iteration() <= 1 ? "<c:boolean>" : "null==string";
                    assertEquals(expected,
                            d.statementAnalysis().stateData().getConditionManagerForNextStatement().condition().toString());
                    String pc = d.iteration() <= 1 ? "!<c:boolean>" : "true";
                    assertEquals(pc, d.statementAnalysis().stateData().getPrecondition().expression().toString());
                }
                if ("1".equals(d.statementId())) {
                    assertEquals("true",
                    ...
                    String expected = switch (d.iteration()) {
                        ...
                        case 1 -> "!<c:boolean>&&null==<field*:org.e2immu.analyser.parser.eventual.testexample.EventuallyE1Immutable_0.string>";
