...
//                    assertNotEquals(MultiLevel.NULLABLE_DV, d.getProperty(Property.NOT_NULL_EXPRESSION));
            ...
            if ("setString".equals(d.methodInfo().name)) {
                ...
                if ("1".equals(d.statementId())) {
                    ...
                    String expected = switch (d.iteration()) {
                        case 0 -> "<precondition>&&<precondition>&&!<c:boolean>&&null==<field:org.e2immu.analyser.parser.eventual.testexample.EventuallyE1Immutable_0.string>";
                        case 1 -> "<precondition>&&<precondition>&&<precondition>&&null==<field*:org.e2immu.analyser.parser.eventual.testexample.EventuallyE1Immutable_0.string>";
        ...
        MethodAnalyserVisitor methodAnalyserVisitor = d -> {
            if ("setString".equals(d.methodInfo().name)) {
                String expected = switch (d.iteration()) {
                    case 0 -> "<precondition>";
                    case 1 -> "<precondition>&&<precondition>&&<precondition>&&null==<f*:string>";
                    default -> "null==string";
                };
            ...
            if ("setString2".equals(d.methodInfo().name)) {
                String expected = switch (d.iteration()) {
                    case 0 -> "<precondition>";
                    case 1 -> "<precondition>&&null==<f*:string>";
                    default -> "null==string";
                };
                assertEquals(expected, d.methodAnalysis().getPreconditionForEventual().expression().toString());
                if (d.iteration() > 3) {
