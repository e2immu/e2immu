            ...
            if ("setString".equals(d.methodInfo().name)) {
                ...
                if (d.variable() instanceof FieldReference fr && "string".equals(fr.fieldInfo.name)) {
                    String expected = switch (d.iteration()) {
                        case 0 -> "cnn:this.string@Method_setString_0-C;initial:this.string@Method_setString_0-C;initial@Field_string;not_null:this.string@Method_setString_0-C";
                    ...
                    if ("2".equals(d.statementId())) {
                        ...
                        String delay = switch (d.iteration()) {
                            case 0 -> "cnn:this.string@Method_setString_0-C;initial:this.string@Method_setString_0-C;not_null:this.string@Method_setString_0-C;state:this.string@Method_setString_2-E";
                            case 1 -> "break_init_delay:this.string@Method_setString_0-C;cnn:this.string@Method_setString_0-C;not_null:this.string@Method_setString_0-C";
                            default -> "";
                        };
