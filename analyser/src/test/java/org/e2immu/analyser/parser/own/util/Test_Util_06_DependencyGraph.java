    ...
    public void test_0() throws IOException {
        ...
        TypeAnalyserVisitor typeAnalyserVisitor = d -> {
            if ("DependencyGraph".equals(d.typeInfo().simpleName)) {
                assertDv(d, 30, MultiLevel.EVENTUALLY_IMMUTABLE_HC_DV, Property.IMMUTABLE);
                assertDv(d, 30, MultiLevel.INDEPENDENT_HC_INCONCLUSIVE, Property.INDEPENDENT);
            }
    ...
    public void test_1() throws IOException {
            ...
            if ("accept".equals(d.methodInfo().name) && "visit".equals(d.enclosingMethod().name)) {
                if (d.variable() instanceof ParameterInfo pi && "consumer".equals(pi.name)) {
                    ...
                    String expectCm = switch (d.iteration()) {
                        case 0 ->
                                "constructor-to-instance@Method_accept_0-E;initial:n.t@Method_accept_0-C;link@NOT_YET_SET";
                        default -> "true:1";
                    };
        ...
        StatementAnalyserVisitor statementAnalyserVisitor = d -> {
            ...
            if ("visit".equals(d.methodInfo().name)) {
                ...
                String expected = switch (d.iteration()) {
                    case 0 ->
                            "consumer={context-modified=constructor-to-instance@Method_accept_0-E;initial:n.t@Method_accept_0-C;link@NOT_YET_SET, context-not-null=not_null:5, read=true:1}, this={context-modified=constructor-to-instance@Method_accept_0-E;initial:n.t@Method_accept_0-C;link@NOT_YET_SET}";
                    default ->
                            "consumer={context-modified=true:1, context-not-null=not_null:5, read=true:1}, this={context-modified=false:0}";
                };
                assertEquals(expected, d.statementAnalysis().propertiesFromSubAnalysersSortedToString());
            }
        };
