    ...
    public void test_0() throws IOException {
        EvaluationResultVisitor evaluationResultVisitor = d -> {
            if ("recursivelyCollectTerms".equals(d.methodInfo().name)) {
                ...
                if ("4".equals(d.statementId())) {
                    String expected = d.iteration() < 90 ? "<null-check>" : "expression instanceof MethodCall";
                    assertEquals(expected, d.evaluationResult().value().toString());
                }
            }
        };
        StatementAnalyserVisitor statementAnalyserVisitor = d -> {
            if ("recursivelyCollectTerms".equals(d.methodInfo().name)) {
                ...
                if ("6".equals(d.statementId())) {
                    assertEquals(d.iteration() >= 90, d.statementAnalysis().stateData().conditionManagerForNextStatementStatus().isDone());
                }
            ...
            if ("recursivelyCollectTerms".equals(d.methodInfo().name)) {
                if (d.variable() instanceof ParameterInfo pi && "expression".equals(pi.name)) {
                    if ("3".equals(d.statementId())) {
                        String expected = d.iteration() < 64 ? "<p:expression>" : "instance type Expression/*@Identity*/";
                        assertEquals(expected, d.currentValue().toString());
                        assertDv(d, 64, MultiLevel.EFFECTIVELY_NOT_NULL_DV, Property.NOT_NULL_EXPRESSION);
                    }
                    if ("4".equals(d.statementId())) {
                        String expected = d.iteration() < 90 ? "<p:expression>" : "instance type Expression/*@Identity*/";
                        assertEquals(expected, d.currentValue().toString());
                        assertDv(d, 90, MultiLevel.EFFECTIVELY_NOT_NULL_DV, Property.NOT_NULL_EXPRESSION);
                    }
                }
            ...
            if ("accept1".equals(d.methodInfo().name)) {
                if (d.variable() instanceof FieldReference fr && "perComponent".equals(fr.fieldInfo.name)) {
                    if ("0.0.1.0.0".equals(d.statementId())) {
                        assertDv(d, 78, DV.FALSE_DV, CONTEXT_MODIFIED);
                    }
                    if ("0.0.1".equals(d.statementId())) {
                        assertDv(d, 93, DV.FALSE_DV, CONTEXT_MODIFIED);
                    }
                    if ("0.0.2".equals(d.statementId())) {
                        assertDv(d, 94, DV.FALSE_DV, CONTEXT_MODIFIED);
                    }
            ...
            if ("accept6".equals(d.methodInfo().name)) {
                ...
                if ("inequality".equals(d.variableName())) {
                    if ("04.0.0".equals(d.statementId())) {
                        assertCurrentValue(d, 73, "new LinearInequalityInOneVariable(b,y,a*xEquals+c,allowEquals)");
                    }
                }
                if ("intervalX".equals(d.variableName())) {
                    if ("06".equals(d.statementId())) {
                        String expected = d.iteration() < 94 ? "<s:Interval>" : "Interval.extractInterval1(expressionsInX)";
                        assertEquals(expected, d.currentValue().toString());
                    }
                }
            }
        ...
        MethodAnalyserVisitor methodAnalyserVisitor = d -> {
            ...
            if ("extractInterval1".equals(d.methodInfo().name)) {
                ...
                String srv = d.iteration() <= 93 ? "<m:extractInterval1>" : "<undetermined return value>";
            ...
            if ("accept3".equals(d.methodInfo().name)) {
                assertDv(d, 71, DV.FALSE_DV, Property.MODIFIED_METHOD);
                String expected = d.iteration() < 94 ? "<m:accept3>" : "<undetermined return value>";
                assertEquals(expected, d.methodAnalysis().getSingleReturnValue().toString());
            }
            ...
            if ("accept6".equals(d.methodInfo().name)) {
                ...
                String expected = d.iteration() < 94 ? "<m:accept6>" : "/*inline accept6*/instance type boolean";
                assertEquals(expected, d.methodAnalysis().getSingleReturnValue().toString());
            }
            if ("accept1".equals(d.methodInfo().name)) {
                assertDv(d, 94, DV.FALSE_DV, Property.MODIFIED_METHOD);
                String expected = d.iteration() < 94 ? "<m:accept1>" : "<undetermined return value>";
                assertEquals(expected, d.methodAnalysis().getSingleReturnValue().toString());
            }
        };
