    ...
    public void test_0() throws IOException {
        ...
        TypeAnalyserVisitor typeAnalyserVisitor = d -> {
            ...
            if ("LinearInequalityInOneVariable".equals(d.typeInfo().simpleName)) {
                assertDv(d, 102, MultiLevel.INDEPENDENT_HC_DV, INDEPENDENT);
                assertDv(d, 102, MultiLevel.NOT_CONTAINER_INCONCLUSIVE, CONTAINER);
            }
            if ("Term".equals(d.typeInfo().simpleName)) {
                assertDv(d, 75, MultiLevel.EFFECTIVELY_IMMUTABLE_HC_DV, IMMUTABLE);
            }
        };
