    ...
    public void test11_2() throws IOException {
        StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
            ...
            if ("getSet".equals(d.methodInfo().name)) {
                if (d.variable() instanceof FieldReference fr && "set".equals(fr.fieldInfo.name)) {
                    assertEquals(MultiLevel.NULLABLE_DV, d.getProperty(CONTEXT_NOT_NULL));
                    assertDv(d, 3, MultiLevel.MUTABLE_DV, IMMUTABLE);
                    String expectValue = d.iteration() <= 2 ? "<f:set>" : "instance type Set<String>";
                    assertEquals(expectValue, d.currentValue().toString());
                }
                if (d.variable() instanceof ReturnVariable) {
                    String expect = switch (d.iteration()) {
                        case 0 -> "<f:set>";
                        case 1,2 -> "<vp:set:ext_not_null@Field_set;initial:c1.set@Method_addAllOnC_0-C;initial:d1.set@Method_addAllOnC_0-C>";
                        default -> "set";
                    };
                    assertEquals(expect, d.currentValue().toString());
                    String expectDelay = switch (d.iteration()) {
                        case 0 -> "initial:this.set@Method_getSet_0-C";
                        case 1,2 -> "ext_not_null@Field_set;initial:c1.set@Method_addAllOnC_0-C;initial:d1.set@Method_addAllOnC_0-C";
                        default -> "";
                    };
            ...
            if ("add".equals(d.methodInfo().name) && "C1".equals(d.methodInfo().typeInfo.simpleName)) {
                if (d.variable() instanceof FieldReference fr && "set".equals(fr.fieldInfo.name)) {
                    String expectValue = d.iteration() <= 2 ? "<f:set>"
            ...
            if ("example1".equals(d.methodInfo().name)) {
                ...
                if (d.variable() instanceof ReturnVariable && "2".equals(d.statementId())) {
                    String causesOfDelay = switch (d.iteration()) {
                        ...
                        case 2 -> "ext_not_null@Field_set;initial:c1.set@Method_addAllOnC_0-C;initial:d1.set@Method_addAllOnC_0-C;initial:this.s2@Method_example1_0-C";
                        default -> "";
                    };
        ...
        FieldAnalyserVisitor fieldAnalyserVisitor = d -> {
            if ("set".equals(d.fieldInfo().name)) {
                ...
                assertDv(d, 3, MultiLevel.EFFECTIVELY_CONTENT_NOT_NULL_DV, EXTERNAL_NOT_NULL);
        ...
        MethodAnalyserVisitor methodAnalyserVisitor = d -> {
            if ("C1".equals(d.methodInfo().name)) {
                assertDv(d.p(0), 3, MultiLevel.EFFECTIVELY_CONTENT_NOT_NULL_DV, NOT_NULL_PARAMETER);
