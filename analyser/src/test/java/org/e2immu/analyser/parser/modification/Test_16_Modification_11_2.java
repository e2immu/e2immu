    ...
    public void test11_2() throws IOException {
        StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
            ...
            if ("getSet".equals(d.methodInfo().name)) {
                if (d.variable() instanceof FieldReference fr && "set".equals(fr.fieldInfo.name)) {
                    ...
                    String expectValue = d.iteration() <= 13 ? "<f:set>" : "instance type Set<String>";
            ...
            if ("add".equals(d.methodInfo().name) && "C1".equals(d.methodInfo().typeInfo.simpleName)) {
                if (d.variable() instanceof FieldReference fr && "set".equals(fr.fieldInfo.name)) {
                    String expectValue = d.iteration() <= 13 ? "<f:set>"
            ...
            if ("example1".equals(d.methodInfo().name)) {
                ...
                if ("c".equals(d.variableName())) {
                    ...
                    if ("2".equals(d.statementId())) {
                        assertDv(d, 16, MultiLevel.EFFECTIVELY_NOT_NULL_DV, CONTEXT_NOT_NULL);

                        String expectLinked = d.iteration() <= 15 ? "c.set:-1,this.s2:-1" : "c.set:2,this.s2:2";
        ...
        FieldAnalyserVisitor fieldAnalyserVisitor = d -> {
            ...
            if ("s2".equals(d.fieldInfo().name)) {
                assertDv(d, 15, MultiLevel.EFFECTIVELY_CONTENT_NOT_NULL_DV, EXTERNAL_NOT_NULL);
            }
        };
