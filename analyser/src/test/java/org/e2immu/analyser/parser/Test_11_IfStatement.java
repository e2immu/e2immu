    ...
    public void test0() throws IOException {
        MethodAnalyserVisitor methodAnalyserVisitor = d -> {
            if ("method1".equals(d.methodInfo().name)) {
                ...
                assertTrue(value instanceof InlinedMethod);
            }
        };
        ...
        StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
            if ("method1".equals(d.methodInfo().name) && d.variable() instanceof ReturnVariable retVar) {
                assertEquals(RETURN, retVar.fqn);
                if ("0".equals(d.statementId())) {
                    assertEquals("null==a?\"b\":<return value>", d.currentValue().toString());
                }
    ...
    public void test1() throws IOException {
        ...
        StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
            if ("method2".equals(d.methodInfo().name) && d.variable() instanceof ReturnVariable retVar) {
                ...
                if ("0".equals(d.statementId())) {
                    assertEquals("null==b?\"b\":b", d.currentValue().toString());
                }
            }
        };
    ...
    public void test2() throws IOException {
        ...
        StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
            if ("method3".equals(d.methodInfo().name) && d.variable() instanceof ReturnVariable retVar) {
                assertEquals(RETURN, retVar.fqn);
                if ("0.0.0".equals(d.statementId())) {
                    assertEquals("c", d.currentValue().toString());
                }
                if ("0".equals(d.statementId())) {
                    assertEquals("null==c?<return value>:c", d.currentValue().toString());
                }
                if ("1".equals(d.statementId())) {
                    assertEquals("null==c?\"abc\":c", d.currentValue().toString());
                }
            }
        };
    ...
    public void test3() throws IOException {
        MethodAnalyserVisitor methodAnalyserVisitor = d -> {
            if (d.iteration() > 0 && "method4".equals(d.methodInfo().name)) {
                Expression value = d.methodAnalysis().getSingleReturnValue();
                assertEquals("null==c?\"abc\":\"cef\"", value.toString());
            }
        };
        ...
        StatementAnalyserVariableVisitor statementAnalyserVariableVisitor = d -> {
            if (d.methodInfo().name.equals("method4") && "res".equals(d.variableName())) {
                if ("0".equals(d.statementId())) {
                    ...
                    assertTrue(d.variableInfo().isRead()); // twice actually
    ...
    public void test4() throws IOException {
        ...
        FieldAnalyserVisitor fieldAnalyserVisitor = d -> {
            if ("map".equals(d.fieldInfo().name)) {
                assertEquals(0, d.fieldAnalysis().getProperty(VariableProperty.CONTAINER));
            }
        };
