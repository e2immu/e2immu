...
// variant on _21, different array initialisation
// still not expecting a null pointer warning
public class Loops_21_2 {
    ...
    public static String[][] method(int n, int m) {
        ...
        for (int i = 0; i < n - 1; i++) { // 2
            ...
            String inner = "xzy";
            for (int j = i; j < m; j++) { // 2.0.2
                int outerMod = i % outer.length(); // 2.0.2.0.0
