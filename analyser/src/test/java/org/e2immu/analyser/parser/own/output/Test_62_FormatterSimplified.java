            ...
            if ("forward".equals(d.methodInfo().name)) {
                ...
                if (d.variable() instanceof ReturnVariable) {
                    if ("9".equals(d.statementId())) {
                        String expected = switch (d.iteration()) {
                            case 0 ->
                                    "!<instanceOf:Space>&&<m:apply>&&<m:length>>=1&&-1+<v:end>>=<v:pos>&&<f:NEWLINE>!=<m:get>&&(!<v:allowBreak>||!<v:wroteOnce>||-<v:chars>+<p:maxChars>-<m:length>>=(!<instanceOf:Guide>&&<v:wroteOnce>&&<m:length>>=1&&-1+<v:end>>=<v:pos>&&<v:lastOneWasSpace>!=<f:NONE>&&<v:lastOneWasSpace>!=<f:RELAXED_NONE>&&<f:NEWLINE>!=<m:get>?1:0))";
                            case 1 ->
                                    "!<c:boolean>&&(<c:boolean>?<m:apply>&&!<c:boolean>:<m:apply>&&([list.get(pos$8),<v:allowBreak>,<vl:chars>,<vl:end>,end$8,<v:lastOneWasSpace>,<vp:NONE:container@Class_ElementarySpace>,<f:RELAXED_NONE>,<f:RELAXED_NONE>,<vp:NEWLINE:container@Record_Space>,<dv:scope-scope-81:25:8.0.3.split>,<f:NEVER>,<p:maxChars>,<vl:pos>,pos$8,<vl:wroteOnce>,<s:boolean>,<m:get>,<m:get>,<instanceOf:Space>,<new:ForwardInfo>,<m:length>,<m:apply>,<m:combine>,<c:boolean>,<c:boolean>,<c:boolean>,<too complex>])&&<m:length>>=1)&&<vp:NEWLINE:container@Record_Space>!=<m:get>&&-1+<vl:end>>=(-1+end$8>=pos$8&&list.get(pos$8)!=<vp:NEWLINE:container@Record_Space>?1+(<c:boolean>?<vl:pos>:<c:boolean>?<new:ForwardInfo>:<m:length>>=1?<vl:pos>:instance type int):start)";
                            case 2 ->
                                    "!<c:boolean>&&(<c:boolean>?<m:apply>&&!<c:boolean>:<m:apply>&&([list.get(pos$8),<v:allowBreak>,<vl:chars>,<vl:end>,end$8,<v:lastOneWasSpace>,<f:NONE>,<f:RELAXED_NONE>,<f:RELAXED_NONE>,<vp:NEWLINE:cm@Parameter_split;mom@Parameter_split>,<dv:scope-scope-81:25:8.0.3.split>,<f:NEVER>,<p:maxChars>,<vl:pos>,pos$8,<vl:wroteOnce>,<s:boolean>,<m:get>,<m:get>,<instanceOf:Space>,<new:ForwardInfo>,<m:length>,<m:apply>,<m:combine>,<c:boolean>,<c:boolean>,<c:boolean>,<too complex>])&&<m:length>>=1)&&<vp:NEWLINE:cm@Parameter_split;mom@Parameter_split>!=<m:get>&&-1+<vl:end>>=(-1+end$8>=pos$8&&list.get(pos$8)!=<vp:NEWLINE:cm@Parameter_split;mom@Parameter_split>?1+(<c:boolean>?<vl:pos>:<c:boolean>?<new:ForwardInfo>:<m:length>>=1?<vl:pos>:instance type int):start)";
                            case 3 ->
