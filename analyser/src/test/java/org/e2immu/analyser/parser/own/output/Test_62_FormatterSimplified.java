...
public class Test_62_FormatterSimplified extends CommonTestRunner {
    ...
    public void test_2() throws IOException {
                ...
                if ("writeSpace".equals(d.variableName())) {
                    ...
                    if ("8.0.4.1.0.1.0.0.03".equals(d.statementId())) {
                        String expected = d.iteration() < 3
                                ...
                                : "wroteOnce$8&&ElementarySpace.NONE!=(outputElement instanceof Symbol symbol?FormatterSimplified_2.combine(lastOneWasSpace$8,null):nullable instance type ElementarySpace)&&ElementarySpace.RELAXED_NONE!=(outputElement instanceof Symbol symbol?FormatterSimplified_2.combine(lastOneWasSpace$8,null):nullable instance type ElementarySpace)";
                        assertEquals(expected, d.currentValue().toString());
                        assertFalse(d.variableInfo().getLinkedVariables().stream()
                                .anyMatch(e -> "symbol".equals(e.getKey().simpleName())));
                    }
                ...
                if (d.variable() instanceof ReturnVariable) {
                    if ("9".equals(d.statementId())) {
                        String expected = switch (d.iteration()) {
                            ...
                            case 1 ->
                                    "!<c:boolean>&&(<c:boolean>?<m:apply>&&!<c:boolean>:<m:apply>&&([list.get(pos$8),<v:allowBreak>,<vl:chars>,<vl:end>,end$8,<v:lastOneWasSpace>,<vp:NONE:container@Class_ElementarySpace>,<f:RELAXED_NONE>,<f:RELAXED_NONE>,<vp:NEWLINE:container@Record_Space>,<dv:scope-scope-81:25:8.0.3.split>,<f:NEVER>,maxChars,<p:maxChars>,<vl:pos>,pos$8,<vl:wroteOnce>,<s:boolean>,<m:get>,<m:get>,<m:combine>,<instanceOf:Space>,<new:ForwardInfo>,<m:length>,<m:apply>,<c:boolean>,<c:boolean>,<c:boolean>,<too complex>])&&<m:length>>=1)&&<vp:NEWLINE:container@Record_Space>!=<m:get>&&-1+<vl:end>>=(-1+end$8>=pos$8&&list.get(pos$8)!=<vp:NEWLINE:container@Record_Space>?1+(<c:boolean>?instance type int:<c:boolean>?<new:ForwardInfo>:<m:length>>=1?<vl:pos>:instance type int):start)";
                            case 2 ->
                                    "!<c:boolean>&&(<c:boolean>?<m:apply>&&!<c:boolean>:<m:apply>&&([list.get(pos$8),<v:allowBreak>,<vl:chars>,<vl:end>,end$8,<v:lastOneWasSpace>,<f:NONE>,<f:RELAXED_NONE>,<f:RELAXED_NONE>,<vp:NEWLINE:cm@Parameter_split;mom@Parameter_split>,<dv:scope-scope-81:25:8.0.3.split>,<f:NEVER>,maxChars,<p:maxChars>,<vl:pos>,pos$8,<vl:wroteOnce>,<s:boolean>,<m:get>,<m:get>,<m:combine>,<instanceOf:Space>,<new:ForwardInfo>,<m:length>,<m:apply>,<c:boolean>,<c:boolean>,<c:boolean>,<too complex>])&&<m:length>>=1)&&<vp:NEWLINE:cm@Parameter_split;mom@Parameter_split>!=<m:get>&&-1+<vl:end>>=(-1+end$8>=pos$8&&list.get(pos$8)!=<vp:NEWLINE:cm@Parameter_split;mom@Parameter_split>?1+(<c:boolean>?instance type int:<c:boolean>?<new:ForwardInfo>:<m:length>>=1?<vl:pos>:instance type int):start)";
                            case 3 ->
                                    "[list.get(1+pos$8)/*(Symbol)*/.symbol().length(),(outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\").length(),(outputElement instanceof Symbol symbol?list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\").length(),list.get(1+pos$8),list.get(pos$8),list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start),writer.apply(new ForwardInfo(pos,chars,null,Split.NEVER,list.get(pos$8)/*(Guide)*/,false)),writer.apply(new ForwardInfo(pos,chars,([(outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),FormatterSimplified_2.combine(lastOneWasSpace$8,null),chars$8,end$8,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,scope-scope-81:25:8.0.3.split,Split.NEVER,maxChars,outputElement,pos$8,wroteOnce$8,instance type boolean])?\" \"+(outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\"):outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\",split,null,outputElement instanceof Symbol)),FormatterSimplified_2.combine(lastOneWasSpace$8,null),FormatterSimplified_2.combine(outputElement instanceof Space space?FormatterSimplified_2.combine(nullable instance type ElementarySpace,null):outputElement instanceof Guide guide||([(outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),writer.apply(new ForwardInfo(pos,chars,([(outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),FormatterSimplified_2.combine(lastOneWasSpace$8,null),chars$8,end$8,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,scope-scope-81:25:8.0.3.split,Split.NEVER,maxChars,outputElement,pos$8,wroteOnce$8,instance type boolean])?\" \"+(outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\"):outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\",split,null,outputElement instanceof Symbol)),FormatterSimplified_2.combine(lastOneWasSpace$8,null),chars$8,end$8,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,scope-scope-81:25:8.0.3.split,Split.NEVER,maxChars,outputElement,pos$8,wroteOnce$8,instance type boolean])?outputElement instanceof Symbol symbol?FormatterSimplified_2.combine(lastOneWasSpace$8,null):nullable instance type ElementarySpace:outputElement instanceof Symbol symbol?null:ElementarySpace.RELAXED_NONE,null),FormatterSimplified_2.combine(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?outputElement instanceof Space space?FormatterSimplified_2.combine(nullable instance type ElementarySpace,null):outputElement instanceof Guide guide||([(outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),writer.apply(new ForwardInfo(pos,chars,([(outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),FormatterSimplified_2.combine(lastOneWasSpace$8,null),chars$8,end$8,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,scope-scope-81:25:8.0.3.split,Split.NEVER,maxChars,outputElement,pos$8,wroteOnce$8,instance type boolean])?\" \"+(outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\"):outputElement instanceof Symbol symbol?list.get(pos$8)/*(Symbol)*/.symbol():outputElement instanceof Guide?\"\":\"abc\",split,null,outputElement instanceof Symbol)),FormatterSimplified_2.combine(lastOneWasSpace$8,null),chars$8,end$8,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,scope-scope-81:25:8.0.3.split,Split.NEVER,maxChars,outputElement,pos$8,wroteOnce$8,instance type boolean])?outputElement instanceof Symbol symbol?FormatterSimplified_2.combine(lastOneWasSpace$8,null):nullable instance type ElementarySpace:outputElement instanceof Symbol symbol?null:ElementarySpace.RELAXED_NONE:ElementarySpace.NICE,null),chars$8,<vl:end>,end$8,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?list.get(pos$8)/*(Symbol)*/.left():nullable instance type Space).split,scope-scope-81:25:8.0.3.split,Split.NEVER,start,maxChars,outputElement,pos$8,wroteOnce$8,<too complex>,<too complex>]";
                            default ->
        ...
        testClass("FormatterSimplified_2", 3, 1, new DebugConfiguration.Builder()
