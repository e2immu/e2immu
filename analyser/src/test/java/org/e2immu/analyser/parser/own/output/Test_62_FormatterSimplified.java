...
public class Test_62_FormatterSimplified extends CommonTestRunner {
    ...
    public void test_2() throws IOException {
                ...
                if (d.variable() instanceof ReturnVariable) {
                    if ("9".equals(d.statementId())) {
                        String expected = switch (d.iteration()) {
                            ...
                            case 1 ->
                                    "[list.get(pos$8),<v:allowBreak>,<vl:chars>,<vl:end>,end$8,<vl:lastOneWasSpace>,<vp:NICE:container@Class_ElementarySpace>,<vp:NONE:container@Class_ElementarySpace>,<f:RELAXED_NONE>,<f:RELAXED_NONE>,<vp:NEWLINE:container@Record_Space>,<dv:scope-scope-81:25:8.0.3.split>,<f:NEVER>,start,maxChars,<p:maxChars>,<vl:pos>,pos$8,<vl:wroteOnce>,<s:boolean>,<m:get>,<m:get>,<m:elementarySpace>,<m:combine>,<instanceOf:Space>,<new:ForwardInfo>,<m:length>,<m:apply>,<m:apply>,<too complex>,<c:boolean>,<c:boolean>,<c:boolean>,<c:boolean>,<too complex>]";
                            case 2 ->
                                    "[list.get(pos$8),<v:allowBreak>,<vl:chars>,<vl:end>,end$8,<v:lastOneWasSpace>,ElementarySpace.NICE,<f:NONE>,ElementarySpace.RELAXED_NONE,<f:RELAXED_NONE>,<f:RELAXED_NONE>,<vp:NEWLINE:cm@Parameter_split;mom@Parameter_split>,<dv:scope-scope-81:25:8.0.3.split>,<f:NEVER>,start,maxChars,<p:maxChars>,<vl:pos>,pos$8,<v:wroteOnce>,<s:boolean>,<m:get>,<m:get>,<instanceOf:Space>,<new:ForwardInfo>,<m:length>,<m:apply>,<m:apply>,<too complex>,<c:boolean>,<c:boolean>,<c:boolean>,<c:boolean>,<too complex>]";
                            case 3 ->
                                    "[(list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\").length(),(list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start) instanceof Symbol?list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start)/*(Symbol)*/.symbol():list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start) instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start),writer.apply(new ForwardInfo(pos$8,chars$8,wroteOnce$8&&([(list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),chars$8,end$8,lastOneWasSpace$8,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,scope-scope-81:25:8.0.3.split,Split.NEVER,maxChars,pos$8,wroteOnce$8,instance type boolean])&&lastOneWasSpace$8!=ElementarySpace.NONE&&lastOneWasSpace$8!=ElementarySpace.RELAXED_NONE?\" \"+(list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\"):list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\",list.get(pos$8) instanceof Symbol?scope-scope-81:25:8.0.3.split:nullable instance type Split,null,list.get(pos$8) instanceof Symbol)),chars$8,<vl:end>,end$8,lastOneWasSpace$8,ElementarySpace.NICE,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?(instance type Symbol).left():nullable instance type Space).split,scope-scope-81:25:8.0.3.split,Split.NEVER,start,maxChars,pos$8,wroteOnce$8,<m:length>,<m:apply>,<m:apply>,<too complex>,<too complex>]";
                            default ->
                                    "[(([(list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start),list.size(),writer.apply(new ForwardInfo(pos,chars,wroteOnce$8&&([(list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),chars$8,end$8,lastOneWasSpace$8,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,scope-scope-81:25:8.0.3.split,Split.NEVER,maxChars,pos$8,wroteOnce$8,instance type boolean])&&lastOneWasSpace$8!=ElementarySpace.NONE&&lastOneWasSpace$8!=ElementarySpace.RELAXED_NONE?\" \"+(list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\"):list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\",split,null,outputElement instanceof Symbol)),chars$8,end$8,lastOneWasSpace$8,ElementarySpace.NICE,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,scope-scope-81:25:8.0.3.split,Split.NEVER,start,maxChars,pos$8,wroteOnce$8,instance type boolean])?list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start)/*(Symbol)*/.symbol():\"\").length(),(list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\").length(),(list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start) instanceof Symbol?list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start)/*(Symbol)*/.symbol():list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start) instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),list.get(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?1+pos$8:start),list.size(),writer.apply(new ForwardInfo(pos,chars,null,Split.NEVER,list.get(pos$8)/*(Guide)*/,false)),writer.apply(new ForwardInfo(pos,chars,wroteOnce$8&&([(list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\").length(),list.get(pos$8),chars$8,end$8,lastOneWasSpace$8,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,scope-scope-81:25:8.0.3.split,Split.NEVER,maxChars,pos$8,wroteOnce$8,instance type boolean])&&lastOneWasSpace$8!=ElementarySpace.NONE&&lastOneWasSpace$8!=ElementarySpace.RELAXED_NONE?\" \"+(list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\"):list.get(pos$8) instanceof Symbol?list.get(pos$8)/*(Symbol)*/.symbol():list.get(pos$8) instanceof Guide?\"\":\"abc\",split,null,outputElement instanceof Symbol)),chars$8,end$8,lastOneWasSpace$8,ElementarySpace.NICE,ElementarySpace.NONE,ElementarySpace.RELAXED_NONE,Space.NEWLINE,(-1+end$8>=pos$8&&list.get(pos$8)!=Space.NEWLINE?(instance type Symbol).left():nullable instance type Space).split,scope-scope-81:25:8.0.3.split,Split.NEVER,start,maxChars,pos$8,wroteOnce$8,instance type boolean]";
                        };
                        assertEquals(expected, d.currentValue().toString());
                    }
                }
        ...
        testClass("FormatterSimplified_2", 3, 2, new DebugConfiguration.Builder()
        ...
        MethodAnalyserVisitor methodAnalyserVisitor = d -> {
            if ("apply".equals(d.methodInfo().name)) {
                ...
                String expected = d.iteration() < 3 ? "<m:apply>"
                        : "/*inline apply*/list.get(forwardInfo.pos) instanceof Guide";
                assertEquals(expected, d.methodAnalysis().getSingleReturnValue().toString());
            }
        };
