...
public class TestTypeInfoStream {
    ...
    final MethodInfo genericContainerPutMethod = new MethodInfo(containerTypeInfo, "put",
            List.of(new ParameterInfo(typeT, "value", 0)),
            typeT, false);
    ...
    final MethodInfo intSum = new MethodInfo(typeInfo, "sum",
            List.of(new ParameterInfo(primitives.intTypeInfo, "x", 0),
                    new ParameterInfo(primitives.intTypeInfo, "y", 1)), primitives.intParameterizedType, true);
