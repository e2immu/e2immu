...
public class TestMethodCallLinkedVariables extends CommonTest {
    ...
    private void minimalMethodAnalysis(DV identity,
                                       DV fluent,
                                       DV independent,
    ...
    public void test1() {
        minimalMethodAnalysis(DV.FALSE_DV, DV.FALSE_DV, MultiLevel.DEPENDENT_DV, null);
    ...
    public void test2() {
        DV delay = DelayFactory.createDelay(methodInfo.newLocation(), CauseOfDelay.Cause.IDENTITY);
        minimalMethodAnalysis(delay, DV.FALSE_DV, MultiLevel.DEPENDENT_DV, null);
    ...
    public void test3() {
        minimalMethodAnalysis(DV.TRUE_DV, DV.FALSE_DV, MultiLevel.DEPENDENT_DV, null);
    ...
    public void test3B() {
        minimalMethodAnalysis(DV.FALSE_DV, DV.TRUE_DV, MultiLevel.DEPENDENT_DV, null);
        LinkedVariables lv = defineObjectAndComputeLV(mutablePt, LINK_ASSIGNED, LINK_DEPENDENT, LINK_COMMON_HC_ALL);
    ...
    public void test4() {
        DV delay = DelayFactory.createDelay(methodInfo.newLocation(), CauseOfDelay.Cause.VALUE_INDEPENDENT);
        minimalMethodAnalysis(DV.FALSE_DV, DV.FALSE_DV, delay, null);
        LinkedVariables lv = defineObjectAndComputeLV(mutablePt, LINK_ASSIGNED, LINK_DEPENDENT, LINK_COMMON_HC_ALL);
    ...
    public void test5() {
         ...
         */
        minimalMethodAnalysis(DV.FALSE_DV, DV.FALSE_DV, MultiLevel.INDEPENDENT_DV, null);
        LinkedVariables lv = defineObjectAndComputeLV(mutablePt, LINK_ASSIGNED, LINK_DEPENDENT, LINK_STATICALLY_ASSIGNED);
    ...
    @Test
    @DisplayName("mutable object, dependent method")
    public void test6() {
        minimalMethodAnalysis(DV.FALSE_DV, DV.FALSE_DV, MultiLevel.DEPENDENT_DV, SELECT_0);
        LV commonHC = LV.createHC(SELECT_0, SELECT_1);
        assertEquals("<0>-4-<1>", commonHC.toString());
        LinkedVariables lv = defineObjectAndComputeLV(mutablePt, LINK_STATICALLY_ASSIGNED, LINK_DEPENDENT, commonHC);
    ...
    public void test7() {
        ...
        LinkedVariables lv = defineObjectAndComputeLV(recursivelyImmutablePt, LINK_ASSIGNED, LINK_ASSIGNED, LINK_ASSIGNED);
    ...
    public void test8() {
        ...
        LinkedVariables lv = defineObjectAndComputeLV(immutableHCPt, LINK_STATICALLY_ASSIGNED, LINK_ASSIGNED, commonHC);
    ...
    @Test
    @DisplayName("mutable object, method independent HC")
    public void test9() {
        minimalMethodAnalysis(DV.FALSE_DV, DV.FALSE_DV, MultiLevel.INDEPENDENT_HC_DV, SELECT_0);
        LV commonHC = LV.createHC(SELECT_0, SELECT_0);
        LinkedVariables lv = defineObjectAndComputeLV(mutablePt, LINK_STATICALLY_ASSIGNED, LINK_DEPENDENT, commonHC);
    ...
    private LinkedVariables defineObjectAndComputeLV(ParameterizedType objectType, LV lvo, LV lva, LV lvb) {
        Expression zero = IntConstant.zero(primitives);
        VariableExpression va = makeLVAsExpression("a", zero);
        VariableExpression vb = makeLVAsExpression("b", zero);
