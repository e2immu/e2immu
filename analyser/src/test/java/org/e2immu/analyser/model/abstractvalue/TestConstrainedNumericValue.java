...
public class TestConstrainedNumericValue extends CommonAbstractValue {
    ...
    public void testEquals0() {
        ...
        Value eqGe0 = equals(ge0, newInt(0));
    ...
    public void testEquals2() {
        ...
        Value eqGt1 = equals(gt1, newInt(2));
        Assert.assertTrue(eqGt1 instanceof EqualsValue);
    ...
    public void testEncodeSize() {
        ...
        Assert.assertEquals(Level.SIZE_NOT_EMPTY, cnv1.encodedSizeRestriction(minimalEvaluationContext));
    }
    ...
    public void testSpecialEquals1() {
        ConstrainedNumericValue gt1 = ConstrainedNumericValue.lowerBound(minimalEvaluationContext, i, 1);
        Value gt1Gt2 = GreaterThanZeroValue.greater(minimalEvaluationContext, gt1, newInt(2), true);
        Assert.assertEquals("((-2) + i,?>=1) >= 0", gt1Gt2.toString());

        ConstrainedNumericValue gt0 = ConstrainedNumericValue.lowerBound(minimalEvaluationContext, i, 0);
        Value gt0Gt2 = GreaterThanZeroValue.greater(minimalEvaluationContext, gt0, newInt(2), true);
    ...
    public void testSpecialEquals2() {
        ...
        ConstrainedNumericValue gt0 = ConstrainedNumericValue.lowerBound(minimalEvaluationContext, i, 0);
        Value gt0Gt3 = GreaterThanZeroValue.greater(minimalEvaluationContext, gt0, newInt(3), true);
    ...
    public void testCombination() {
        ...
        Value combined = newAndAppend(gt1Gt2, gt0Gt3);
