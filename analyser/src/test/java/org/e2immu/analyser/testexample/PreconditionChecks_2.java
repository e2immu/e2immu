...
public class PreconditionChecks_2 {
    ...
    private static boolean combinedPrecondition1$Precondition(int p1, int p2) { return p1 >= 2 && p2 > 0; }
    public void combinedPrecondition1(int p1, int p2) {
        if (p1 < 2 || p2 <= 0) throw new UnsupportedOperationException();
        this.i = p1 > p2 ? p1 + 3 : p2;
    }

    private static boolean combinedPrecondition2$Precondition(int p1, int p2) { return p1 >= 2 && p2 > 0; }
