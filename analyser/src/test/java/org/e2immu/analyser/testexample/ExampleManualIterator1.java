...
public class ExampleManualIterator1<E> {
    ...
    @Independent // implies @NotModified; Otherwise we cannot have @E2Container; is so because MyIteratorImpl is @Independent
    ...
    public void visit(@Exposed MyConsumer<E> consumer) { // follows because there are no means of self-modifying
