...
public class TestVariableInfoContainer extends CommonVariableInfo {
    ...
    public void test1() {
        ...
        VariableInfoContainer vic = new VariableInfoContainerImpl(a, VariableInfoContainer.START_OF_METHOD,
                VariableInfoContainer.NOT_A_VARIABLE_FIELD, false, null);
    ...
    public void test2() {
        ...
        VariableInfoContainer previousVic = new VariableInfoContainerImpl(a,
                VariableInfoContainer.START_OF_METHOD, VariableInfoContainerImpl.NOT_A_VARIABLE_FIELD, false, null);
        VariableInfoContainer vic = new VariableInfoContainerImpl(previousVic);
        VariableInfo vi = vic.current();
        ...
        vic.prepareForValueChange(VariableInfoContainer.LEVEL_4_SUMMARY, VariableInfoContainer.START_OF_METHOD,
