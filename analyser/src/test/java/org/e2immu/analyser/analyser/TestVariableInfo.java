...
public class TestVariableInfo extends CommonVariableInfo {
    ...
    public void testNoneNoOverwrite() {
        ...
        VariableInfoImpl vii = viB.merge(minimalEvaluationContext, TRUE, null, false, List.of());
    ...
    public void testNoneOverwrite() {
        VariableInfoImpl viB = new VariableInfoImpl(makeLocalIntVar("b"));
        viB.setStateOnAssignment(TRUE);
        viB.setValue(four);
        viB.setProperty(VariableProperty.NOT_NULL, MultiLevel.MUTABLE);

        VariableInfoImpl overwritten = new VariableInfoImpl(viB.variable);
        try {
            viB.merge(minimalEvaluationContext, TRUE, overwritten, true, List.of());
            Assert.fail();
    ...
    public void testOneOverwrite() {
        ...
        VariableInfoImpl viC2 = viC.merge(minimalEvaluationContext, TRUE, null, true, List.of(viB));
    ...
    public void testOneCisAIfXThenB() {
        ...
        VariableInfoImpl viC2 = viC.merge(minimalEvaluationContext, TRUE, null, false, List.of(viB));
        ...
        VariableInfoImpl viC4 = viC3.merge(minimalEvaluationContext, TRUE, viC2, false, List.of(viB));
    ...
    public void testOneIfXThenReturn() {
        ...
        VariableInfoImpl ret2 = ret.merge(minimalEvaluationContext, TRUE, null, false, List.of(viB));
        ...
        VariableInfoImpl viA = new VariableInfoImpl(makeLocalIntVar("a"));
        viA.setStateOnAssignment(Negation.negate(minimalEvaluationContext, x));
        viA.setValue(three);
        viA.setProperty(VariableProperty.NOT_NULL, MultiLevel.EFFECTIVELY_NOT_NULL);

        VariableInfoImpl ret3 = ret2.merge(minimalEvaluationContext, TRUE, null, false, List.of(viA));
    ...
    public void testOneIfXThenReturnIfYThenReturn() {
        ...
        viB.setStateOnAssignment(xEquals3);
        viB.setValue(four);
        viB.setProperty(VariableProperty.NOT_NULL, MultiLevel.EFFECTIVELY_NOT_NULL);
        ...
        viA.setStateOnAssignment(xEquals4);
        viA.setValue(three);
        viA.setProperty(VariableProperty.NOT_NULL, MultiLevel.EFFECTIVELY_NOT_NULL);
        ...
        viC.setStateOnAssignment(combinedState);
        viC.setValue(two);
        viC.setProperty(VariableProperty.NOT_NULL, MultiLevel.EFFECTIVELY_NOT_NULL);

        VariableInfoImpl ret4 = ret3.merge(minimalEvaluationContext, TRUE, null, false, List.of(viC));
    ...
    public void testOneCisAIfUnclearThenB() {
        ...
        VariableInfoImpl viB = new VariableInfoImpl(makeLocalIntVar("b"));
        viB.setStateOnAssignment(TRUE); // no real idea what the condition is
        viB.setValue(four);
        viB.setProperty(VariableProperty.NOT_NULL, MultiLevel.MUTABLE);
    ...
    public void testTwoOverwriteCisIfXThenAElseB() {
        ...
        VariableInfoImpl viA = new VariableInfoImpl(makeLocalIntVar("a"));
        viA.setStateOnAssignment(x);
        viA.setValue(three);
        viA.setProperty(VariableProperty.NOT_NULL, MultiLevel.EFFECTIVELY_NOT_NULL);

        VariableInfoImpl viB = new VariableInfoImpl(makeLocalIntVar("b"));
        viB.setStateOnAssignment(Negation.negate(minimalEvaluationContext, x));
        viB.setValue(four);
        viB.setProperty(VariableProperty.NOT_NULL, MultiLevel.MUTABLE);
        ...
        VariableInfoImpl viC = new VariableInfoImpl(makeLocalIntVar("c"));
        viC.merge(minimalEvaluationContext, TRUE, viC, true, List.of(viA, viB));
    ...
    public void testTwoOverwriteCisIfXThenAElseA() {
        ...
        VariableInfoImpl viC = new VariableInfoImpl(makeLocalIntVar("c"));
        VariableInfoImpl viC2 = viC.merge(minimalEvaluationContext, TRUE, viC, true, List.of(viA, viB));
